            ...
            <div className="navbar bg-cyan-950">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-50 p-2 shadow bg-base-100 rounded-box w-52 font-mono">
                            {navLinks}
                        </ul>
                    </div>
                ...
                <div className="navbar-center hidden lg:flex">
                    <ul className="menu menu-horizontal px-1 font-mono uppercase tracking-wide">
                        {navLinks}
                    </ul>
                </div>
